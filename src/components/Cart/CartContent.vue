    ...
    <div v-if="cart.length > 0">
      ...
      <div class="products">
        <div class="item" v-for="(product, i) in cart" :key="product.id">
          <div class="one">
            <div class="img">
              <img :src="getImageUrl(product.firstImg)" :alt="product.title" />
            </div>
            <div class="text">
              <router-link
                :to="{
          ...
          <div class="three">
            <div class="quantity">
              ...
              <div class="quantity-btns">
                <button @click="updateCartCount(product, -1)">
          ...
          <div class="four text-end">
            ...
            <div class="mb-1">
              {{ `$${Math.floor(productTotal(product)).toFixed(2)}` }}
            </div>
...
const updateCartCount = (product, change) => {
